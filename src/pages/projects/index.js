    ...
    <Layout pageTitle="Projects">
      <ul>
        <li>Personal Coding Challenges</li>
          <ul>
            <li><Link to="/projects/2023-Feb">To-Do List</Link></li>
          </ul>
        <li>Internship at TYCA</li>
          <ul>
            <li><Link to="/projects/2022-Jun-Aug">PowerPoint Summary of Internship Work</Link></li>
          </ul>
        <li>Tech Talent Pipeline Bootcamp</li>
          <ul>
            <li><Link to="/projects/2022-Jan">Final Week: Capstone Project</Link></li>
          </ul>
